...
//               className="flex items-center gap-2 px-4 py-2 bg-indigo-500/20 text-indigo-400 rounded-lg border border-indigo-500/30 hover:bg-indigo-500/30 transition-colors"
//             >
...
//               disabled={deleting}
//               className="flex items-center gap-2 px-4 py-2 bg-red-500/10 text-red-400 rounded-lg border border-red-500/30 hover:bg-red-500/20 transition-colors disabled:opacity-50"
//             >
...
//           <h2 className="text-xl font-light text-white mb-4">{quiz.title}</h2>
...
//             <span>•</span>
//             <span className="flex items-center gap-1">
//               <Calendar className="w-4 h-4" /> {formatDate(quiz.createdAt)}
//             </span>
//           </div>

//           {quiz.visibility === 'assigned' && (
//             <div className="mt-4 pt-4 border-t border-white/[0.05]">
//               <p className="text-xs text-white/40 mb-2">assigned to:</p>
//               <div className="flex flex-wrap gap-2">
//                 {quiz.assignedTo?.map((studentId, idx) => (
//                   <span key={idx} className="text-xs px-2 py-1 bg-indigo-500/10 text-indigo-400 rounded-md">
//                     Student {idx + 1}
//                   </span>
//                 ))}
//               </div>
...
//             {/* Link Settings */}
//             {showShareSettings && (
//               <div className="p-4 bg-white/[0.02] rounded-xl space-y-3 border border-white/[0.05]">
//                 <label className="flex items-center justify-between">
//                   <span className="text-xs text-white/40">public link (no login required)</span>
//                   <input
//                     type="checkbox"
...
//                 <label className="flex items-center justify-between">
//                   <span className="text-xs text-white/40">allow anonymous submissions</span>
//                   <input
//                     type="checkbox"
...
//                     className="w-full px-3 py-1.5 bg-white/[0.02] border border-white/[0.05] rounded-lg text-white text-xs"
//                   />
//                 </div>
...
//               className="px-4 py-2 bg-indigo-500/20 text-indigo-400 rounded-lg text-sm border border-indigo-500/30 hover:bg-indigo-500/30 transition-colors"
//             >
//               {quiz.shareableLinks?.publicId ? 'Regenerate Link' : 'Generate Link'}
//             </button>
...
//                     value={shareUrl}
//                     readOnly
//                     className="flex-1 px-3 py-2 bg-white/[0.02] border border-white/[0.05] rounded-lg text-sm text-white/60"
//                   />
//                   <button
//                     onClick={copyToClipboard}
//                     className="px-3 py-2 bg-indigo-500/20 text-indigo-400 rounded-lg hover:bg-indigo-500/30 transition-colors"
//                   >
...
//           <h3 className="text-sm font-medium text-white mb-4">questions ({quiz.questions.length})</h3>
          
//           <div className="space-y-4">
//             {quiz.questions.map((q, idx) => (
//               <div key={q.id} className="bg-white/[0.02] rounded-lg p-4 border border-white/[0.05]">
//                 <div className="flex items-start justify-between mb-2">
//                   <span className="text-xs text-white/40">Q{idx + 1}</span>
//                   <span className="text-xs text-indigo-400">{q.marks} marks</span>
//                 </div>
...
//                           : 'bg-white/[0.02] text-white/40 border border-white/[0.05]'
//                       }`}
//                     >
