...
// // ✅ Design tokens (Black & Green Theme)
// const T = {
//   bg: '#070709',
//   bgCard: '#0f0f12',
//   accent: '#10b981',
...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#070709] text-white" style={{ fontFamily: "'DM Sans', 'Sora', sans-serif" }}>
      ...
      {/* Background — lightweight, no GPU-heavy blur */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Top Nav */}
        <nav className="sticky top-0 z-50 border-b border-white/[0.04] bg-[#070709]/95">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div
                key={stat.label}
                className={`relative overflow-hidden bg-white/[0.02] border ${stat.border} rounded-2xl p-4 hover:bg-white/[0.04] transition-colors`}
              >
                    ...
                    {filteredQuizzes.slice(0, 6).map((quiz, i) => (
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                          ...
                          <button
                            onClick={() => handleStartQuiz(quiz.id)}
                            className="flex items-center gap-2 px-4 py-2 bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/20 hover:border-violet-500/40 rounded-xl text-violet-400 text-sm font-medium transition-colors whitespace-nowrap shrink-0"
                          >
                            <PlayCircle className="w-4 h-4" />
                            Start
                          </button>
