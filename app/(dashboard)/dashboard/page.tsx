...
// import { QuizCardSkeleton, StatsSkeleton } from '@/components/ui/loading-skeleton';
...
//                 <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#1a1a23] rounded-xl animate-pulse"></div>
//                 <div className="w-32 h-6 bg-[#1a1a23] rounded animate-pulse"></div>
//               </div>
//               <div className="w-40 h-10 bg-[#1a1a23] rounded-xl animate-pulse"></div>
//             </div>
//           </div>
//         </div>
        
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
//           <div className="bg-[#111117] border border-[#2a2a35] rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 animate-pulse">
//             <div className="h-8 bg-[#1a1a23] rounded w-64 mb-2"></div>
//             <div className="h-4 bg-[#1a1a23] rounded w-48"></div>
//           </div>
...
//                 <div className="h-6 bg-[#1a1a23] rounded w-40 mb-4"></div>
//                 {[1,2,3].map((i) => (
...
//             <div>
//               <div className="bg-[#111117] border border-[#2a2a35] rounded-xl p-4 sm:p-5">
//                 <div className="h-6 bg-[#1a1a23] rounded w-32 mb-4"></div>
//                 {[1,2,3].map((i) => (
//                   <div key={i} className="bg-[#1a1a23] rounded-lg p-3 mb-2 animate-pulse">
//                     <div className="h-4 bg-[#2a2a35] rounded w-3/4 mb-2"></div>
//                     <div className="h-3 bg-[#2a2a35] rounded w-1/2"></div>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//             {/* Right Sidebar */}
//             <div className="space-y-4 sm:space-y-6">
//               {/* Recent Results - WITH CLICKABLE LINKS */}
//               <div className="bg-[#111117] border border-[#2a2a35] rounded-xl p-4 sm:p-5">
//                 <h3 className="text-sm sm:text-base font-semibold text-white mb-3 sm:mb-4 flex items-center gap-2">
//                   <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5 text-purple-400" />
//                   Recent Results
...
//                         key={result.id}
//                         className="block p-2 sm:p-3 bg-[#1a1a23] rounded-lg hover:bg-[#252530] transition-colors cursor-pointer"
//                       >
          ...
          <div className="relative mb-6 sm:mb-8 group">
            ...
            <div className="relative bg-gradient-to-r from-[#1a1a23] to-[#111117] border border-[#2a2a35] rounded-2xl p-4 sm:p-6 overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                {/* UPDATED BUTTON - Now links to /quizzes */}
                <button 
