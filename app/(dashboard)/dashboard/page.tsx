...
//       {/* Background */}
//       <div className="fixed inset-0 pointer-events-none overflow-hidden">
//         <div className="hidden sm:block absolute top-0 left-1/4 w-[600px] h-[600px] bg-violet-600/8 rounded-full blur-[120px]" />
//         <div className="hidden sm:block absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-indigo-600/6 rounded-full blur-[100px]" />
//         <div className="hidden sm:block absolute top-1/2 left-0 w-[300px] h-[300px] bg-purple-500/5 rounded-full blur-[80px]" />
//         {/* Grid - mobile pe bilkul band, desktop pe subtle */}
